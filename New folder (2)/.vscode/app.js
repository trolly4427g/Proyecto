...
window.addEventListener('load', async () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        let dependencia = document.getElementById('nombre').value;
        ...
        generatePDF(fechasolicitud, dependencia, apellidos, email, direccion, telefono, hijos, numeroHijos, discapacidad, discapacidadDesc);
    })

});

async function generatePDF(fechasolicitud, nombres, apellidos, email, direccion, telefono, hijos, numeroHijos, discapacidad, discapacidadDesc) {
    ...
    pdf.setFontSize(12);
    pdf.text(fechasolicitud, 260, 125);
    ...
    pdf.setFontSize(10);
    pdf.text(fechasolicitud, 170, 213);
